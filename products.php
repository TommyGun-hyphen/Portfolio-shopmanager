    ...
    <div class="container border border-dark rounded mt-3">
        <div class="row justify-content-md-center my-4">
            <?php
                ...
                if(empty($products)){
                    echo '<h3 style="margin-bottom:50rem">Try some other filters</h3>';
                }
            ...
            <div class="col col-md-3">
                <div class="card md-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="add_to_cart.php" method="post" class="py-0 my-0 w-100">
                            <button class="btn btn-dark w-100" name="product[id]" value="<?= $product->getId() ?>">Add to cart</button>
                        </form>
                </div>
            </div>
            <?php }?>
